...
<head>
    ...
    <meta name="keywords" content="Admin , Responsive, Landing, Bootstrap, App, iOS, Android, apple, creative app" />
    <meta name="author" content="Bennetts" />
    <!-- Favicon icon -->
                                        ...
                                        <div class="col-xl-12 col-md-12">
                                            <div class="card latest-update-card">
                                                <div class="card-header">
                                                    <h5>Consulta Tecnica de Productos</h5>
                                                        ...
                                                        <div class="row p-b-15">
                                                            ...
                                                            <div class="col-md-12 col-sm-6">
                                                                <div class="card-block-big">
                                                                    ...
                                                                    <div class="row">
                                                                        <label class="col-sm-4 col-lg-2 col-form-label">Codigo</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <label class="col-sm-4 col-lg-2 col-form-label">Ficha Tecnica</label>
                                                                        <div class="col-sm-8 col-lg-10">
                                                                            <div class="input-group">
                                                                                <input type="file" class="form-control" placeholder="Normal Text">
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <label class="col-sm-4 col-lg-2 col-form-label">Hojas de Seguridad</label>
                                                                        <div class="col-sm-8 col-lg-10">
                                                                            <div class="input-group">
                                                                                <input type="file" class="form-control" placeholder="Normal Text">
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <label class="col-sm-4 col-lg-2 col-form-label">Retos Microbianos</label>
                                                                        <div class="col-sm-8 col-lg-10">
                                                                            <div class="input-group">
                                                                                <input type="file" class="form-control" placeholder="Normal Text">
                                                                            </div>
